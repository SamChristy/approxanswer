...
/**
 * Question type class for the approximate answer question type.
 *
 * @package    qtype
...
require_once($CFG->dirroot . '/question/type/approxanswer/question.php');

/**
 * The approximate answer question type.
 */
class qtype_approxanswer extends question_type {
